...
describe('Account MongoDb Repository', () => {
  ...
  describe('loadAccountByToken()', () => {
    ...
    it('Should return an account on loadAccountByToken with admin role', async () => {
      const sut = makeSut()
      await accountCollection.insertOne({
        name: 'any_name',
        email: 'any_email@gmail.com',
    ...
    it('Should return null on loadAccountByToken with invalid role', async () => {
      const sut = makeSut()
      await accountCollection.insertOne({
        name: 'any_name',
        email: 'any_email@gmail.com',
    ...
    it('Should return an account on loadAccountByToken if user is an admin', async () => {
      const sut = makeSut()
      await accountCollection.insertOne({
        name: 'any_name',
        email: 'any_email@gmail.com',
    ...
    it('Should return null if loadAccountByToken fails', async () => {
      const sut = makeSut()
      const account = await sut.loadAccountByToken('any_token')
      expect(account).toBeFalsy()
    })
